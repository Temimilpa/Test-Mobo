<?php
	class Administrator_Model extends CI_Model
	{
		...
		public function get_orders($username = FALSE, $limit = FALSE, $offset = FALSE)
		{
			if ($limit) {
				$this->db->limit($limit, $offset);
			}
		...
		public function get_costo_envio(){
				$query = $this->db->get('costo_envio');
				return $query->row_array(); 
		}
		...
		public function update_costo_envio()
		{ 
			$data = array('costo' => $this->input->post('costo'));
			$d = $this->db->update('costo_envio', $data);
		}
		...
		public function save_product_order($id_product,$id_order)
		{
			$data = array('id_order' => $id_order,
							'id_product' => $id_product);

			$this->db->insert('products_orders', $data);
		...
		{
			$data = array('name' => $this->input->post('nombre_cliente'));
			$this->db->insert('customers', $data);
			$id_customer = $this->db->insert_id();

			$data2 = array('id_customer' => $id_customer, 
							'sub-total' => $this->input->post('subtotal'),
