    ...
    -moz-box-shadow: 0 3px 7px 0 rgba(0,0,0,.2); box-shadow: 0 3px 7px 0 rgb(0 0 0 / 20%);">
  	<div class="container">
       ...
       <ul class="nav navbar-nav navbar-right">
         <li>
          <a href="<?php echo base_url(); ?>pages/cart"><i class="fa fa-shopping-cart fa-2x" style="color:#fff;" aria-hidden="true"><span id="cart_num_products"><?php echo $number ?></span></i></a>
          <input type="hidden" value="<?php echo $number ?>" id="input_num_products"/>        
        </li>
        <!--
